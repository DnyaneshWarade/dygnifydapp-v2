...
const UdyamUpload = ({ handleClick }) => {
    ...
    return (
      <>
        ...
        <Container maxWidth="sm" sx={{ mt: "42px" }}>
          <Stack>
            <Item name="Udyam No" value="XXXXXX" />
            <Item name=" Name of Business" value="XXXXXX" />
            <Item name=" Name of the Entrepreneur" value="XXXXXX" />
  ...
  return <>{selectedFile ? udyamUploadedForm() : udyamUploadForm()}</>;
};
